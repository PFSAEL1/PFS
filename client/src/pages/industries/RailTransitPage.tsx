 ...
 * Gallery: 3 real PFS rail booth interior photos
...
const FEATURES_VISIBLE = [
  { num: "01", title: "Track-Integrated Floor Systems", body: "PFS rail booths are engineered with embedded steel track systems flush with the grated floor. Drive-in configurations accommodate light rail cars, heavy locomotives, and transit vehicles up to 100+ ft in length." },
  { num: "02", title: "Downdraft Airflow for Full-Length Vehicles", body: "Ceiling-to-floor downdraft airflow at uniform face velocity across the full booth length. Eliminates overspray recirculation on long rail vehicles — critical for high-performance transit coatings." },
];
const FEATURES_HIDDEN = [
  { num: "04", title: "Explosion-Proof Electrical Systems", body: "Class I Division 2 (CID2) wiring, fixtures, and controls throughout. UL 508A certified control panels. All electrical meets NFPA 33 and NEC requirements for flammable finishing environments." },
  { num: "05", title: "Scissor Lift & Access Platform Integration", body: "Side-mounted scissor lifts and elevated work platforms can be integrated into the booth structure for full-height access to rail car sides and rooftops during coating operations." },
  { num: "06", title: "Nationwide Installation & Service", body: "PFS-certified technicians install and commission rail finishing facilities at transit authority depots and rail yards nationwide. Full service contracts, parts availability, and emergency response." },
];
const BOOTH_LINEUP = [
  { name: "Drive-Through", desc: "Full drive-through configuration for railcars and locomotives." },
  { name: "Downdraft", desc: "Ceiling-to-floor airflow for maximum overspray control on long vehicles." },
  { name: "Track-Integrated", desc: "Embedded steel rail tracks flush with grated floor walkways." },
  { name: "Heated Booth", desc: "Integrated heat for accelerated cure of transit-grade coatings." },
  { name: "Custom", desc: "Engineered-to-spec for unique rail authority and depot requirements." },
];
...
export default function RailTransitPage() {
  useSEO({
    title: "Rail & Transit Paint Booths | Railcar Finishing Systems | PFS",
    description: "PFS rail and transit spray booths are custom-engineered for railcar, subway car, and locomotive painting. Track-integrated drive-through configurations with embedded steel rail. Ceiling-to-floor downdraft airflow at uniform face velocity across full booth length. NFPA 33 compliant, ETL/UL listed components, CID2 explosion-proof electrical. Custom lengths to 200+ ft. Manufactured in Santa Rosa, CA. Ships to transit authority depots and rail yards nationwide.",
    canonical: "/industries/rail-transit",
  });
      ...
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "flex-end", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, paddingTop: "8rem", paddingBottom: "4.5rem" }}>
          ...
          <span style={{ display: "block", alignItems: "center", gap: "0.4rem", background: "rgba(27,58,107,0.75)", border: "1px solid rgba(107,163,224,0.4)", color: "#6fa3e0", borderRadius: "2px", fontFamily: "'Chakra Petch', 'Barlow Condensed', sans-serif", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", padding: "0.3rem 0.75rem", marginBottom: "1.25rem", width: "fit-content" }}>
            TRACK-INTEGRATED DRIVE-THROUGH BOOTHS
          </span>
          <p data-animation="slideLeft" style={{ fontFamily: "'Archivo Narrow', 'Inter', sans-serif", fontSize: "clamp(0.95rem, 1.8vw, 1.1rem)", color: "rgba(255,255,255,0.82)", lineHeight: 1.7, marginBottom: "2.5rem", maxWidth: "500px" }}>
            Track-integrated drive-through configurations with embedded steel rail. Ceiling-to-floor downdraft airflow at uniform face velocity across the full booth length. ETL/UL listed and UL 508A certified components. NFPA 33 compliant. Custom lengths to 200+ ft — built for light rail, heavy locomotives, and transit authority depots nationwide.
          </p>
        ...
        <div className="container">
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1.5rem" }}>
            ...
            <div style={{ width: "100%", maxWidth: "900px", overflow: "hidden", borderRadius: "2px" }}>
              <img src={FEATURED_IMG} alt="Amtrak locomotive inside PFS rail paint booth" style={{ width: "100%", height: "auto", display: "block", objectFit: "cover" }} />
            </div>
            <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap", justifyContent: "center" }}>
              <Link href="/contact/request-a-quote" data-animation="slideLeft">
                <span className="btn-glow">REQUEST A QUOTE <ArrowRight size={15} /></span>
              </Link>
              <Link href="/products/paint-booths" data-animation="slideRight">
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            {GALLERY.slice(0, 2).map((g) => (
              <ZoomableImage key={g.src} src={g.src} alt={g.alt} style={{ width: "100%", height: "380px", objectFit: "contain", background: "#f2f2f2", display: "block" }} />
            ))}
          </div>
          ...
          {featuresOpen && (
            <>
              ...
              <div style={{ background: "#fff", padding: "2rem", marginBottom: "1.5rem", borderTop: "3px solid #111" }}>
                ...
                <h3 style={{ fontFamily: "'Chakra Petch', 'Barlow Condensed', sans-serif", fontSize: "1.2rem", fontWeight: 800, color: "#111", marginBottom: "1.25rem" }}>Every Rail Application is Different. We Engineer to Fit.</h3>
