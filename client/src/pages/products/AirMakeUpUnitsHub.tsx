          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <Link href="/products/air-make-up-units/heated">
              <div className="group cursor-pointer border border-gray-200 hover:border-[#1B2B4B] transition-all duration-300 hover:shadow-[0_0_24px_rgba(27,43,75,0.15)] overflow-hidden">
                ...
                <div className="p-8">
                  <div className="flex items-start justify-between mb-3" data-animation="slideLeft">
                  ...
                  <span data-animation="slideRight"className="btn-glow inline-flex items-center gap-2">Get Pricing <ArrowRight size={14} /></span>
                </div>
              </div>
            </Link>
