...
const plans = [
  {
    ...
    features: ["1 Booth Tracked", "10% Discount on All Orders", "Free Standard Shipping", "Phone Support", "Monthly Filter Reminders"],
    cta: "Get Started",
    featured: false,
  },
  {
    ...
    features: ["3 Booths Tracked", "15% Discount on All Orders", "Priority Shipping", "Priority Phone Support", "Automated Reorder Reminders", "Filter Change History"],
    cta: "Get Started",
    featured: true,
  },
  {
