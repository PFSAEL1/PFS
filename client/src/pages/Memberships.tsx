            ...
            <Card key={tier.name} className={`relative border-2 ${tier.color} bg-[#0d0d0d] mt-20 overflow-visible`}>
              ...
              <CardContent className="space-y-3">
                ...
                <button
                  ...
                  className="w-full mt-4 flex items-center justify-center gap-2 border border-transparent bg-[#4d9fff] text-black hover:bg-[#6aadff] hover:border-blue-500/50 hover:-translate-y-1 hover:shadow-[0_12px_40px_-12px_rgba(59,130,246,0.35)] py-3 rounded-lg text-sm font-medium transition-[transform,box-shadow,background-color,border-color] duration-200 disabled:opacity-50"
                >
